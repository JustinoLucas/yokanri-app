...
import ThemeEditor, { ThemeEditorButton } from './components/ThemeEditor/index.jsx';
    ...
    <ConfigProvider config={config}>
      ...
      {import.meta.env.DEV && (
        <>
          ...
          <ThemeEditorButton onClick={() => setThemeEditorOpen(true)} />
        </>
      )}
      ...
      {import.meta.env.DEV && themeEditorOpen && (
